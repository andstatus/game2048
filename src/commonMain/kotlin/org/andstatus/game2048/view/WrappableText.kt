...
class WrappableText(
    ...
    init {
        ...
        if (f is Font) {
            ...
            setTextBounds(Rectangle(0.0, 0.0, wrapWidth, metrics.bounds.height))
        }
    }
}

class WrappableTextRenderer(private val wrapWidth: Double, private val gravity: Gravity) : TextRenderer<String> {
